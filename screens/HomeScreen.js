        ...
        return (
            <View>
                <FlatList
                    ...
                    renderItem={({ item }) =>
                        <EventBox item={item} navigation={this.props.navigation} />
                    }
...
function EventBox(props) {
    ...
    return (
        <TouchableOpacity
            ...
            <Image style={styles.eventImage} source={{ uri: "https://twachi-mobileweb.firebaseapp.com/event/" + item.key + ".png" }}
            />
            <View>
...
const styles = StyleSheet.create({
    ...
    eventImage: {
        width: 100, height: 80, marginLeft: 10, marginRight: 10,
        borderRadius: 10,
    },
    eventText: {
        color: "#00A"
