...
import {
    View, FlatList, StyleSheet, Text, Button,
        ...
        function MemberBox(props) {
            ...
            return (
                <TouchableOpacity
                    ...
                    <Image style={styles.memberImage} source={{ uri: "https://twachi-mobileweb.firebaseapp.com/member/" + item.mid + ".jpg" }}
                    />
                    <View>
            ...
            <View style={styles.eventview}>
                <ScrollView>
                    ...
                    <Image style={styles.eventImage}
                        source={{ uri: "https://twachi-mobileweb.firebaseapp.com/event/" + item.key + ".png" }}
                    />
                    ...
                    <FlatList
                        data={item.member}
                        renderItem={({ item }) =>
                            <MemberBox item={item} navigation={this.props.navigation} />
                        }
